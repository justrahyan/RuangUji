    ...
    <>
      <nav style={{
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          {/* Logo */}
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 800, fontSize: '1.25rem', color: 'var(--primary-blue)' }}>
            RuangUji
          </Link>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <Link to="/setup" className="btn btn-primary hidden-mobile" style={{ padding: '0.5rem 1.25rem', fontSize: '0.875rem' }}>
              Mulai Latihan
            </Link>
